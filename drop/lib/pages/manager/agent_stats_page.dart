  ...
  Future<void> _initializeData() async {
    ...
    if (mounted) {
      setState(() {
        ...
        deliveries = performanceStats['performanceStats']['deliveries'] ?? {};
        packages = performanceStats['performanceStats']['packages'] ?? {};
        int delivered = packages['delivered'] ?? 0;
        int total = packages['total'] ?? 0;
        packagesSuccessRate = total > 0 ? delivered / total : 0.0;
        isLoading = false;
      });
    }
  }
